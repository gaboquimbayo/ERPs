...
[ERP_high, ALLERP_high] = pop_loaderp( ...
    ...
    'filepath', sprintf('%sERP_Criterion_Good\', path) ... % Directory path where ERP files are stored
);
...
pop_savemyerp( ...
    ...
    'filepath', sprintf('%sIntention_Grand_Avgs\', path), ... % Directory where the file will be saved
