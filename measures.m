...
% measures path
dirPath = 'ERP_Criterion_All\Measures\';
...
[ERP, ALLERP] = pop_loaderp( 'filename', {'ERPSET_All_CRB_001.erp', 'ERPSET_All_CRB_003.erp', 'ERPSET_All_CRB_004.erp', 'ERPSET_All_CRB_005.erp',...
 'ERPSET_All_CRB_008.erp', 'ERPSET_All_CRB_012.erp', 'ERPSET_All_CRB_015.erp', 'ERPSET_All_CRB_017.erp', 'ERPSET_All_CRB_018.erp',...
 'ERPSET_All_CRB_024.erp', 'ERPSET_All_CRB_026.erp', 'ERPSET_All_CRB_027.erp', 'ERPSET_All_CRB_028.erp', 'ERPSET_All_CRB_029.erp', 'ERPSET_All_CRB_032.erp',...
 'ERPSET_All_CRB_034.erp', 'ERPSET_All_CRB_035.erp', 'ERPSET_All_CRB_037.erp', 'ERPSET_All_CRB_040.erp', 'ERPSET_All_CRB_042.erp',...
 'ERPSET_All_CRB_043.erp', 'ERPSET_All_CRB_045.erp', 'ERPSET_All_CRB_049.erp', 'ERPSET_All_CRB_050.erp', 'ERPSET_All_CRB_054.erp',...
 'ERPSET_All_CRB_056.erp', 'ERPSET_All_CRB_058.erp', 'ERPSET_All_CRB_059.erp', 'ERPSET_All_CRB_060.erp', 'ERPSET_All_CRB_061.erp', 'ERPSET_All_CRB_062.erp',...
 'ERPSET_All_CRB_065.erp', 'ERPSET_All_CRB_066.erp', 'ERPSET_All_CRB_067.erp', 'ERPSET_All_CRB_068.erp', 'ERPSET_All_CRB_069.erp',...
 'ERPSET_All_CRB_070.erp', 'ERPSET_All_CRB_072.erp', 'ERPSET_All_CRB_074.erp', 'ERPSET_All_CRB_075.erp', 'ERPSET_All_CRB_076.erp'}, 'filepath',...
 'C:\Users\gabri\OneDrive\Documents\Cognitive_Effort\ERPs\ERP_Criterion_All\' );

% measures
PA_P3 = pop_geterpvalues( ALLERP, p3_latency,  n_bins,  channels , 'Baseline', 'pre', 'Erpsets',  n_sets, 'FileFormat', 'wide', 'Filename',...
 sprintf('%sP3_PA.xlsx', dirPath), 'Fracreplace', 'NaN', 'InterpFactor',  1, 'Measure', 'peakampbl', 'Neighborhood',  3, 'PeakOnset',  1,...
 'Peakpolarity', 'positive', 'Peakreplace', 'absolute', 'Resolution',  10 );

PA_N2 = pop_geterpvalues( ALLERP, n2_latency,  n_bins,  channels , 'Baseline', 'pre', 'Erpsets',  n_sets, 'FileFormat', 'wide', 'Filename',...
 sprintf('%sN2_PA.xlsx', dirPath), 'Fracreplace', 'NaN', 'InterpFactor',  1, 'Measure', 'peakampbl', 'Neighborhood',  3, 'PeakOnset',  1,...
 'Peakpolarity', 'positive', 'Peakreplace', 'absolute', 'Resolution',  10 );

MA_P3 = pop_geterpvalues( ALLERP, p3_latency,  n_bins,  channels , 'Baseline', 'pre', 'Erpsets',  n_sets, 'FileFormat', 'wide', 'Filename',...
 sprintf('%sP3_MA.xlsx', dirPath), 'Fracreplace', 'NaN', 'InterpFactor',  1, 'Measure', 'meanbl', 'PeakOnset',  1,...
 'Resolution',  10 );

MA_N2 = pop_geterpvalues( ALLERP, n2_latency,  n_bins,  channels , 'Baseline', 'pre', 'Erpsets',  n_sets, 'FileFormat', 'wide', 'Filename',...
 sprintf('%sN2_MA.xlsx', dirPath), 'Fracreplace', 'NaN', 'InterpFactor',  1, 'Measure', 'meanbl', 'PeakOnset',  1,...
 'Resolution',  10 );
